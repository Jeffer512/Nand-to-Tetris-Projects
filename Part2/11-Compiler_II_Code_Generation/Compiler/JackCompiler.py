...
for file in files_list:
    ...
    # Write the generated vm code to an output file with the same name as the input file but with a .vm extension
    with open((path + file).split(".")[0] + '.vm', 'w') as f:
        for j in compiled.vm.vmcode:
            f.write(j + '\n')
